(function(){
  ...
  function ensureModal(){
    ...
    modal.innerHTML='<section style="width:min(680px,96vw);margin:3vh auto;background:#fff;color:#071027;border-radius:22px;padding:16px;font-family:system-ui;box-shadow:0 24px 80px rgba(0,0,0,.3)">'
      ...
      +'<p>Admin-Beta hochladen, getestete Version freigeben oder einen Kanal zuruecksetzen. Jede Aktion laeuft ueber Branch, Tests und Pull Request.</p>'
      +'<pre id="kggReleaseStatus" style="white-space:pre-wrap;background:#f3f6fa;border-radius:12px;padding:10px"></pre>'
      +'<div style="display:grid;gap:8px"><button id="kggReleaseLogin" type="button">Mit GitHub verbinden</button>'
      ...
      +'<button id="kggReleaseUpload" type="button">HTML waehlen und Admin-Beta hochladen</button>'
      +'<button id="kggReleasePromote" type="button">Diese Beta fuer Kolleg:innen freigeben</button>'
