const KGG_SW_VERSION = 'kgg-therapist-v363-github-update-check';
const KGG_CACHE = KGG_SW_VERSION + '-app-shell';
const KGG_SHELL = [
  './',
  './KGG_APP_ADMIN_v363_github_update_check.html',
  './KGG_APP_KOLLEGEN_v363_github_update_check.html',
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith(
    fetch(request)
      ...
      .catch(() => caches.match(request).then(cached => cached || caches.match('./KGG_APP_KOLLEGEN_v363_github_update_check.html')))
  );
});
