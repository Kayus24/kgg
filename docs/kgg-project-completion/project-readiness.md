...
| G12 | Release, Installation, Canary, Rollback und Betriebsmodus sind nachgewiesen. | Gemergter SHA, Post-Merge-Canary, Evidence-Reconciliation und Rückfall auf Custom GPT sind dokumentiert. | E3/E4 Merge-, Canary- und Rollback-Evidence | `PARTIAL_COMPLETE_WITH_TECHNICAL_LIMITS` | PR #247/Required Checks sind abgeschlossen; Post-Merge-Canary, externe Host-Parität und Envelope-Reconciliation bleiben wegen der technischen Grenze offen. | [G12](12-release-migration-and-operations.md) |
