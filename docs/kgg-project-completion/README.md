...
| G06 | Reale Quick Flows | `PARTIAL` | Drei kanonische Flows plus echter Locator-Drift-Fallback lokal nachgewiesen; Replay fehlt noch | Mindestens drei reale, versionierte Flows mit Fallback, Step Evidence und unverändertem Replay | [G06](06-real-quick-flows.md) |
