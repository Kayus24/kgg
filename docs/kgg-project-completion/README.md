...
| G12 | Release, Migration und Betrieb | `PARTIAL_COMPLETE_WITH_TECHNICAL_LIMITS` | PR #264 mit Code-Merge-SHA `f65d16a2c0e13df4ef0e26fd5b777383466a02c2` und grünen Required Gates; der nachgelagerte Dokumentationsabgleich ist in PR #265 gemergt; UI-Parität, externe Envelope-Reconciliation und Post-Merge-Visual-Canary bleiben wegen fehlendem Action-Kanal bzw. fehlendem Run-/Kosten-Gate offen | Custom GPT bleibt Fallback; keine weitere Observation oder Discovery ohne neues Capability-Signal; `ACTION_THEN_VERIFY` und Canary benötigen jeweils ein separates gebundenes Gate | [G12](12-release-migration-and-operations.md) · [aktueller Post-Merge-Status](CURRENT_POST_MERGE_STATUS_20260923.json) |
