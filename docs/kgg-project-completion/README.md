...
| G12 | Release, Migration und Betrieb | `PARTIAL_COMPLETE_WITH_TECHNICAL_LIMITS` | PR #256–#260 gemergt; aktueller Main `3f9225b6de45e4c46c7deedb86a3e8a2899ecdb1`; Required Gates grün; kein zweiter B-Canary und kein Post-Merge-Canary ausgeführt | Custom GPT bleibt Fallback; keine Migration oder Ersetzbarkeit behaupten; nächster Schritt ist ausschließlich ein separat freizugebender Runtime-Diagnoselauf | [G12](12-release-migration-and-operations.md) |
