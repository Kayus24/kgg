...
| G12 | Release, Migration und Betrieb | `PARTIAL_COMPLETE_WITH_TECHNICAL_LIMITS` | PR #262 mit Main-SHA `eb3ad0e88bd6b98b27a5c0e37262bf9ad1cea0f1` gemergt; Required Gates und der Post-Merge-Pages-Build grün; der lokale `request/v1`-Contract-Fix ist kanonisch; UI-Parität, externe Envelope-Reconciliation und Post-Merge-Visual-Canary bleiben offen | Bestehenden Tunnel neu verbinden, Bundle-/Schema-Bindung read-only prüfen und erst danach einen separat gebundenen Observe-Diagnoselauf erwägen; Custom GPT bleibt Fallback | [G12](12-release-migration-and-operations.md) · [aktueller Post-Merge-Status](CURRENT_POST_MERGE_STATUS_20260923.json) |
