...
| G03 | Normales ChatGPT erkennt und nutzt das Plugin | `PARTIAL` (`DISCOVERY_VISIBLE_EXECUTION_UNVERIFIED`) | Plugin-Detailseite lädt und zeigt den Tool-Katalog; ein aktueller normaler-ChatGPT-Tool-Call fehlt noch; historischer Canary bleibt retained | Ein einzelner read-only Tool-Call nur mit separatem Kosten-/Kommunikations-Gate; sonst Custom-GPT-Fallback | [G03](03-chatgpt-plugin-connection.md) |
