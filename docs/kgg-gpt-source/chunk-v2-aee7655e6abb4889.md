...
<script type="application/json" id="kgg-patch-rules">
{
  ...
  "changelogSizePolicy": {
    ...
    "targetEmbeddedEntriesAfterCompaction": 15,
    "archiveSnapshotMode": "full-pre-compaction-snapshot",
    "archiveReferenceField": "kgg-changelog.archiveSnapshots",
    "archiveLoadPolicy": "Load only for history older than the embedded runtime window.",
    "warnAtEntries": 18,
  ...
  "lastUpdatedByPatchId": "kgg-v092-ticket-015-admin-stage-release-fixes",
