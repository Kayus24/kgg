<script>
(function(){'use strict';
  const VERSION='KGG_GITHUB_UPDATE_v085_ticket_015_progressions';
  ...
  const KGG_BUILD_INFO={"release":"v085","buildTime":"2026-09-10T22:26:33Z","buildCode":"module-v085-ticket-015-progressions","htmlFile":"kgg-update/index.html"};
