<script>
(function(){'use strict';
  const VERSION='KGG_GITHUB_UPDATE_v066_tablet_package_save_preview';
  ...
  const KGG_BUILD_INFO={"release":"v066","buildTime":"2026-08-14T11:08:14Z","buildCode":"module-v066-tablet-package-save-preview","htmlFile":"kgg-update/index.html"};
