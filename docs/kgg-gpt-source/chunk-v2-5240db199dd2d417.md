<script>
(function(){'use strict';
  const VERSION='KGG_GITHUB_UPDATE_v088_ticket_037_real_plan';
  ...
  const KGG_BUILD_INFO={"release":"v088","buildTime":"2026-09-11T17:23:53Z","buildCode":"module-v088-ticket-037-real-plan","htmlFile":"kgg-update/index.html"};
