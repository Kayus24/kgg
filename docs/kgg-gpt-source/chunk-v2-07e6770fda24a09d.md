<script>
(function(){'use strict';
  const VERSION='KGG_GITHUB_UPDATE_v065_source_control_char_guard';
  ...
  const KGG_BUILD_INFO={"release":"v065","buildTime":"2026-08-10T18:41:19Z","buildCode":"module-v065-source-control-char-guard","htmlFile":"kgg-update/index.html"};
