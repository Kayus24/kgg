  ...
  "entries": [
    {
      ...
      "status": "scaffolded",
      "type": "module-patch",
      "title": "Progressionsvarianten",
      "reason": "Geordnete Progressionsstufen werden im Admin-Editor und der Patienten-App über den bestehenden Planvertrag unterstützt.",
      "whatChanged": [
        "Geordnete Progressionsstufen werden im Admin-Editor und der Patienten-App über den bestehenden Planvertrag unterstützt."
      ],
      "touchedAreas": [
        "Plan-State",
        "QR/Patienten-App",
