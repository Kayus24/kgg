<script>
(function(){'use strict';
  const VERSION='KGG_GITHUB_UPDATE_v083_therapy_cockpit_id_guard';
  ...
  const KGG_BUILD_INFO={"release":"v083","buildTime":"2026-09-09T03:04:11Z","buildCode":"module-v083-therapy-cockpit-id-guard","htmlFile":"kgg-update/index.html"};
