  ...
  window.KGGTicket015AdminPersistence={
    upsert:(ex,reason)=>upsertPlanExerciseToBank(ex,reason),
    sync:(reason)=>syncStatePlanToStore(reason||'ticket_015_progression_variants'),
    persistBank:()=>persistCustomBank(),
    save:()=>save()
  };
