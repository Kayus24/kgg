<script>
(function(){'use strict';
  const VERSION='KGG_GITHUB_UPDATE_v066_editor_trash_bank_delete';
  ...
  const KGG_BUILD_INFO={"release":"v066","buildTime":"2026-08-13T22:31:49Z","buildCode":"module-v066-editor-trash-bank-delete","htmlFile":"kgg-update/index.html"};
