<script>
(function(){'use strict';
  const VERSION='KGG_GITHUB_UPDATE_v084_therapy_cockpit_start_link';
  ...
  const KGG_BUILD_INFO={"release":"v084","buildTime":"2026-09-09T19:31:29Z","buildCode":"module-v084-therapy-cockpit-start-link","htmlFile":"kgg-update/index.html"};
