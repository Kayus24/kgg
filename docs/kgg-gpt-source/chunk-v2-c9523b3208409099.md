...
1. <script type="application/json" id="kgg-source-truth">
{
  ...
  "currentVersion": {
    ...
    "lastPatchId": "kgg-v088-ticket-037-real-plan",
    "updatedBy": "kgg-module-scaffolder"
  },
  "latestPatchId": "kgg-v088-ticket-037-real-plan",
  "lastUpdateIntent": {
    "id": "kgg-v088-ticket-037-real-plan",
    "summary": "Der sichtbare Cockpit-Einstieg und der Fertig-Dialog importieren den normalen aktuellen Plan fail-closed in Slot 1.",
    "touched": [
      "Therapie-Cockpit",
      "Test-Harness",
