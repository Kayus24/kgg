...
def run_android_wrapper_contract() -> None:
    ...
    required = [
        ...
        ("onPermissionRequest(PermissionRequest request)", "Android WebView handles in-app camera permission requests"),
        ("PermissionRequest.RESOURCE_VIDEO_CAPTURE", "Android WebView grants only video capture for the in-app scanner"),
        ("WEB_CAMERA_PERMISSION_REQUEST", "Web camera permission is isolated from file chooser camera fallback"),
