(()=>{
  const VERSION='v7_real_media_only';
  ...
  function setBox(id,html,cls){const box=mediaBox(id);if(!box)return;box.className='kggMediaBox '+(cls||'');box.innerHTML=html;}
