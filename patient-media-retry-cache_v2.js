(()=>{
  const VERSION='v8_closed_card_thumbnail';
  ...
  function ensureStyle(){
    ...
    style.textContent=`
      ...
      #list .ex .kggCardThumb img{display:block;width:100%;height:100%;object-fit:cover;background:#fff}
      #list .ex:not(.kggOpen).kggThumbReady .kggCardThumb{display:block}
      #list .ex.kggOpen .kggCardThumb{display:none!important}
      @media(max-width:430px){#list .ex.kggHasThumb{padding-right:106px;min-height:112px}#list .ex .kggCardThumb{width:78px;height:68px;right:10px;border-radius:13px}}
    `;
