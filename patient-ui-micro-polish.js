(()=>{
  const VERSION='v5_pain_wrap_fix';
  ...
  function ensureStyle(){
    ...
    s.textContent=`
      ...
      body.kggAlwaysCollapsed .ex .pain:not(.kggHiddenGlobalPain) .kggPainScale{margin-top:8px!important;min-width:0!important;width:100%!important;grid-template-columns:repeat(6,minmax(44px,1fr))!important;gap:6px!important}
      ...
      .kggSetPain .kggPainScale{grid-template-columns:repeat(6,minmax(44px,1fr))!important;gap:6px!important}.kggSetPain .kggPainScale button{min-height:44px!important;font-size:15px!important;border-radius:12px!important;min-width:44px!important}
